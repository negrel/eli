...
log_debug "adding $ELI_SWAP_ID swap entry to fstab..."
echo "$ELI_SWAP_ID	none	swap	sw	0	0" >> /etc/fstab
log_debug "$ELI_SWAP_ID swap entry added to fstab."
